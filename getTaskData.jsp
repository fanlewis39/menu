...
<%
	...
	try{
        ...
        String sql = "SELECT ITEM_SEARCH_ as wbs,ITEM_NAME_ as name,ITEM_ANNEX as annex,ITEM_NOTES_ as note,ITEM_RECTIFICATION as measures, item_reportdate as handle FROM tlk_weekreport WHERE ITEM_SEARCH_ ='"+ wbs +"'";
